          ...
          <div className="fixed bottom-0 left-0 right-0 bg-gray-900 border-t border-gray-700">
            <div className="flex justify-around items-center py-3">
              ...
              >
                ...
                <span className="text-green-400 text-xs font-medium">Cashout</span>
              </button>
              <button 
              ...
              >
                ...
                <span className="text-gray-400 text-xs">Daily Rewards</span>
              </button>
              <button 
                onClick={() => setActiveTab('offers')}
                className="flex flex-col items-center space-y-1 px-4 py-2"
              >
                ...
                <span className="text-gray-400 text-xs">Earn</span>
              </button>
              <button 
